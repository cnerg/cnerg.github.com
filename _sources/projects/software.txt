...
* `Svalinn <http://github.com/svalinn>`_ is a collection of tools
  ...
  * `ATR NSUF Experiment Design Toolkit <atr>`_ is an analysis
    workflow, based on the DAGMC toolkit, to facilitate rapid design
    iterations for ATR NSUF experiments.
